...
<body class="bg-gray-300">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-center mb-8 text-blue-600">Parkhausverwaltung der BCG GmbH</h1>
    ...
    <script>
        ...
        document.getElementById('parkhausForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await axios.post('/parkhaus', formData);
        ...
        document.getElementById('einfahrtForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await axios.post('/ein-ausfahrt/einfahrt', formData);
        ...
        document.getElementById('ausfahrtForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await axios.post('/ein-ausfahrt/ausfahrt', formData);
        ...
        async function ladeParkhaeuser() {
            try {
                const response = await axios.get('/parkhaus');
        ...
        async function zeigeBetrag() {
            ...
            try {
                const response = await axios.post('/kassenautomat/zeige-betrag', {
        ...
        async function barzahlung() {
            ...
            try {
                const response = await axios.post('/kassenautomat/barzahlung', {
        ...
        async function kreditkartenzahlung() {
            ...
            try {
                const response = await axios.post('/kassenautomat/kreditkartenzahlung', {
                    ticket_id: currentTicket,
